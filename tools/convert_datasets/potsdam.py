...
from utils import mkdir_or_exist, path_whether_exists, pic_imread
...
def clip_big_image(image_path, clip_save_dir, args, to_label=False):
    ...
    path_whether_exists(image_path)
    image = pic_imread(image_path)
...
def main():
    ...
    for zipp in zipp_list:
        with tempfile.TemporaryDirectory(dir=args.tmp_dir) as tmp_dir:
            ...
            tqdm1 = tqdm
            for src_path in tqdm1(src_path_list):
